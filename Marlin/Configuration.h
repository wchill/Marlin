...
#define STRING_CONFIG_H_AUTHOR "(wchill, CR-10 V2)" // Who made the changes.
...
#define X_BED_SIZE 290 // Nozzle is at X10 when homed
#define Y_BED_SIZE 290 // Nozzle is at Y10 when homed
